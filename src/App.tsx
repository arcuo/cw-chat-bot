...
function App() {
	...
	return (
		<div className="h-full text-2xl flex flex-col px-[30%] py-[20%] gap-2">
			<m.div
			...
			>
				<span className="font-bold">Hugh Benjamin Zachariae</span> / Software Engineer
			</m.div>
			...
			<AnimatePresence mode="wait">
				{showPromptValue ? (
					...
					>
						...
						/>
						<div className="opacity-40 text-[.9rem] mt-5">Press spacebar</div>
					</motion.div>
				)}
			</AnimatePresence>
		</div>
