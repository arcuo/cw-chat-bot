...
// TODO: ThreeJS, RAG AI, DevEx scripts, Ruff linter project, Frontend Tech lead community leader

/** Combine the project content into a string */
export function generateProjectContent(project: Project) {
	const content = `TITLE: ${project.title} - ${project.subtitle}\nCONTENT: ${project.productDescription}\n${project.content.join("\n")}\nTAGS: ${project.tags.join(", ")}`;
	return content;
}
