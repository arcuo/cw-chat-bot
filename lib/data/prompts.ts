...
export const prompts = {
	...
	senior: {
		...
		prompt:
			"We are searching for a developer with a large range of experience in different languages and facets of software development. We are looking for a developer who can work independently and as part of a team and who has experience in agile development, estimating and developing durable software.",
	},
	techlead: {
		title: "Tech Lead Developer",
		prompt:
			"We are looking for a senior developer who has experience in leading a team and leading the architectural development of our platform. We look for a developer with experience in agile development, estimating and planning software development tasks.",
	},
};
